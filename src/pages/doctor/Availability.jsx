...
const Availability = () => {
  ...
  // ✅ Individual Slot Logic with Day & Time details
  const handleSlotAction = (day, time) => {
    let newStatus = "";
    const updated = { ...slots };
    updated[day] = updated[day].map(slot => {
  ...
  return (
    <div className="availability-page">
      ...
      {/* ✅ Premium Toast with Correct "X" Placement */}
      {popup && (
        <div className={`toast-notification ${popup.type}`}>
          <div className="toast-main">
            <span className="toast-icon">{popup.type === "success" ? "✅" : "⚠️"}</span>
